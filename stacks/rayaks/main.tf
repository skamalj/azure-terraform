...
# Required for mounting model stored on azure storage
...
# Assign "Network Contributor" role to AKS managed identity for the VNet, required for Node Auto-Provisioning with Karpenter
